...
const Data = () => {
  return (
    <div className='home__data'>
        ...
        <p className="home__description">I'm creative designer based in New York ans I'm very passionate and dedicated to my work.</p>

        <a href="#contat" className="button button--flex">
            Say Hello
            <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
